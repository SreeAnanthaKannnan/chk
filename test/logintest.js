...
describe("login", function() {
  it("Login Successful", function(done) {
    ...
    api
      .post("/login")
      .send({ email_id: "vici@gmail.com", password: "Vici@123" })
      .set("Accept", "application/json", {})
      .expect(200)
      .end(function(err, res) {
        expect(res.status).equals(200);
        res.body.should.have.property("email_id");
  ...
  //     api
  //       .post("/changeMpin")
  //       .send({ old_mpin: 1234, new_mpin: 5678, confirm_mpin: 5678 })
  //       .set("Accept", "application/json", {
  //         access_token:
  //           "x0T5sE22eBWdD-CTIZsKBG-4b6tsZoSDqV5UCyd7igxWevfB3b_AaCT76PCfBKZ",
  //         lang: "en"
  //       })
  //       .expect(401)
  //       .end(function(err, res) {
  ...
  it("Invalid Username", function(done) {
    ...
    api
      .post("/login")
      .send({ email_id: "man@v.com", password: "Vici@123" })
      .set("Accept", "application/json", {})
      .expect(400)
      .end(function(err, res) {
        res.status.should.equal(401);
