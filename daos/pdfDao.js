...
//=================================================================
function pdf_insert(path,email,checked1,checked2,checked3,checked4,checked5,checked6,checked7,checked8,checked9) {
    ...
    console.log(result,"value 220")
    console.log(result[0].P220V,"daop220")

if(result[0].P220V ==null && result[0].FASA==null && result[0].FARS==null && result[0].FAFS==null && result[0].TAMS==null && result[0].FPPS==null && result[0].FPFS==null && result[0].SIM==null && result[0].TLA==null && result[0].Assessment1==null){
         var sql= "UPDATE Buildings SET P220V ='"+checked1+"', FASA='"+checked2+"', FARS='"+checked3+"',FAFS='"+checked4+"',TAMS='"+checked5+"', FPPS='"+checked6+"', FPFS='"+checked7+"',SIM='"+checked8+"',TLA='"+checked9+"',Assessment1='yes',Flag='1' where email_id='"+owner_id+"'";
         con.query(sql,function(err,result)
         {
        ...
        //  else if(result[0].P220V !=null && result[0].FASA!=null && result[0].FARS!=null && result[0].FAFS!=null && result[0].TAMS!=null && result[0].FPPS!=null && result[0].FPFS!=null && result[0].SIM!=null && result[0].TLA!=null && result[0].FACR!=null && result[0].Assessment2==null){
                ...
                var sql= "UPDATE Buildings SET P220V ='"+checked1+"', FASA='"+checked2+"', FARS='"+checked3+"',FAFS='"+checked4+"',TAMS='"+checked5+"', FPPS='"+checked6+"', FPFS='"+checked7+"',SIM='"+checked8+"',TLA='"+checked9+"',Assessment2='yes',Flag='2' where email_id='"+owner_id+"'";
        ...
        //    else if(result[0].A3P220V ==null && result[0].A3FASA==null && result[0].A3FARS==null && result[0].A3FAFS==null && result[0].A3TAMS==null && result[0].A3FPPS==null && result[0].A3FPFS==null && result[0].A3SIM==null && result[0].A3TLA==null && result[0].A3FACR==null && result[0].Assessment3==null){
            // var sql= "UPDATE Buildings SET A3P220V ='"+checked1+"', A3FASA='"+checked2+"', A3FARS='"+checked3+"',A3FAFS='"+checked4+"',A3TAMS='"+checked5+"', A3FPPS='"+checked6+"', A3FPFS='"+checked7+"',A3SIM='"+checked8+"',A3TLA='"+checked9+"', A3FACR='"+checked10+"',Assessment3='yes',Flag='3' where email_id='"+owner_id+"'";
                ...
                var sql= "UPDATE Buildings SET P220V ='"+checked1+"', FASA='"+checked2+"', FARS='"+checked3+"',FAFS='"+checked4+"',TAMS='"+checked5+"', FPPS='"+checked6+"', FPFS='"+checked7+"',SIM='"+checked8+"',TLA='"+checked9+"',Assessment3='yes',Flag='3' where email_id='"+owner_id+"'";
            con.query(sql,function(err,result)
            {
             if(err) { console.log("something",err)
                 return reject({ "status": 400, "body": 'Cannot insert the data' })}
