...
//         mysqlConnection
//         .query_execute(query.pdfinsert1, owner_id)
...
//     var params=[ checked1,checked2,checked3,checked4,checked5,checked6,checked7,checked8,checked9,checked10,owner_id]
//     mysqlConnection
//     .query_execute(query.pdfinsert2,params)
//     .then(function(result,err) {
...
//             var params=[ checked1,checked2,checked3,checked4,checked5,checked6,checked7,checked8,checked9,checked10,owner_id]
//     mysqlConnection
//     .query_execute(query.pdfinsert4,params)
//             .then(function(result,err) {
...
//             var params=[ checked1,checked2,checked3,checked4,checked5,checked6,checked7,checked8,checked9,checked10,owner_id]
//             mysqlConnection
//             .query_execute(query.pdfinsert5,params)
//             .then(function(result,err) {
...
//                  mysqlConnection
//                  .query_execute(query.pdfinsert6, params)
//                  .then(function(result,err) {
...
//        params=[path,owner_id]
//        mysqlConnection
//        .query_execute(query.pdfinsert7, params)
//                  .then(function(result,err) {
...
//     params=[path,owner_id]
//     mysqlConnection
//     .query_execute(query.pdfinsert8, params)
//     .then(function(result,err) {
