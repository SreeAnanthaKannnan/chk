...
async function gr_select(params) {
    return new Promise(function (resolve, reject) {
        ...
        // console.log("achie")
        con.query("SELECT * FROM General_Registration where Company_Email ='" + params + "'", (err, result) => {
...
function email_otp_update(params1, params2) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        var sql = "UPDATE General_Registration SET otp = '" + params1 + "' WHERE Company_Email = '" + params2 + "'";
