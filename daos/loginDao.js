...
async function service(email) {
    ...
    return new Promise(async function (resolve, reject) {
        ...
        //var password=loginobject.password;
        //var sql = "SELECT  * FROM Residents where email_id ='" + email_id + "'";
        var sql = "SELECT citizens.mobile_number,Buildings.Buildingname,Buildings.lat,Buildings.lon,Buildings.plotno,Buildings.location,Buildings.simnumber,Buildings.NSP,Buildings.SPCN,Buildings.FAC,Buildings.P220V,Buildings.FASA,Buildings.FARS,Buildings.FAFS,Buildings.TAMS,Buildings.FPPS,Buildings.FPFS,Buildings.SIM,Buildings.TLA,Buildings.Assessment1,Buildings.Assessment2,Buildings.Assessment3,Buildings.Flag,Schedules.FACP,Schedules.CSI,Schedules.BRAND,Schedules.status FROM citizens inner join Buildings on Buildings.email_id = citizens.email_id inner join Schedules on Schedules.email_id=Buildings.email_id And Buildings.email_id='" + email_id + "'";
        //var sql="SELECT citizens.mobile_number,Buildings.lat,Buildings.lon FROM citizens,Buildings where Buildins.email_id ='"+ email_id+"'";
        //var sql = "select * from citizens where email_id ='"+ email_id +"'";
        con.query(sql, function (err, result) {
            if (err) {
        ...
        con.query(sql, function (err, result) {
            ...
            if (result[0].Assessment1 == 'yes' && result[0].Flag == '1') {
                var sql = "SELECT citizens.mobile_number,Buildings.Buildingname,Buildings.lat,Buildings.lon,Buildings.plotno,Buildings.location,Buildings.simnumber,Buildings.NSP,Buildings.SPCN,Buildings.FAC,Buildings.P220V,Buildings.FASA,Buildings.FARS,Buildings.FAFS,Buildings.TAMS,Buildings.FPPS,Buildings.FPFS,Buildings.SIM,Buildings.TLA,Buildings.Assessment1,Buildings.Flag FROM citizens inner join Buildings on Buildings.email_id = citizens.email_id And Buildings.email_id='" + email_id + "'";
                //var sql="SELECT citizens.mobile_number,Buildings.lat,Buildings.lon FROM citizens,Buildings where Buildins.email_id ='"+ email_id+"'";
                //var sql = "select * from citizens where email_id ='"+ email_id +"'";
                con.query(sql, function (err, result) {
                    if (err) {
                ...
                var sql = "SELECT citizens.mobile_number,Buildings.Buildingname,Buildings.lat,Buildings.lon,Buildings.plotno,Buildings.location,Buildings.simnumber,Buildings.NSP,Buildings.SPCN,Buildings.FAC,Buildings.P220V,Buildings.FASA,Buildings.FARS,Buildings.FAFS,Buildings.TAMS,Buildings.FPPS,Buildings.FPFS,Buildings.SIM,Buildings.TLA,Buildings.Assessment2,Buildings.Flag FROM citizens inner join Buildings on Buildings.email_id = citizens.email_id And Buildings.email_id='" + email_id + "'";
                //var sql="SELECT citizens.mobile_number,Buildings.lat,Buildings.lon FROM citizens,Buildings where Buildins.email_id ='"+ email_id+"'";
                //var sql = "select * from citizens where email_id ='"+ email_id +"'";
                con.query(sql, function (err, result) {
                    if (err) {
                ...
                var sql = "SELECT citizens.mobile_number,Buildings.Buildingname,Buildings.lat,Buildings.lon,Buildings.plotno,Buildings.location,Buildings.simnumber,Buildings.NSP,Buildings.SPCN,Buildings.FAC,Buildings.P220V,Buildings.FASA,Buildings.FARS,Buildings.FAFS,Buildings.TAMS,Buildings.FPPS,Buildings.FPFS,Buildings.SIM,Buildings.TLA,Buildings.Assessment3,Buildings.Flag FROM citizens inner join Buildings on Buildings.email_id = citizens.email_id And Buildings.email_id='" + email_id + "'";
                //var sql="SELECT citizens.mobile_number,Buildings.lat,Buildings.lon FROM citizens,Buildings where Buildins.email_id ='"+ email_id+"'";
                //var sql = "select * from citizens where email_id ='"+ email_id +"'";
                con.query(sql, function (err, result) {
                    if (err) {
