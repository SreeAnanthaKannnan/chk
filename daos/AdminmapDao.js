...
var sql="SELECT Buildings.lat,Buildings.lon FROM Schedules INNER JOIN Buildings ON Schedules.building_id=Buildings.id AND Schedules.status!='installed' AND Buildings.lat!='null' AND Buildings.lon!='null'";
