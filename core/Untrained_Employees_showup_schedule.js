...
exports.Untrained_Employees_schedule = (data, token, language) =>
  new Promise(async (resolve, reject) => {
    ...
    if (verifytoken.status == 405) {
      ...
      let Untrained_Employees = await Employee_profileDao.Untrained_Employees_schedule(
      ...
      if (language == "ar") {
        for (i = 0; i < total_length.length; i++) {
          obj = {
            ...
            Company_Trade_Lincense_No:
              total_length[i].Company_Trade_Lincense_No,
