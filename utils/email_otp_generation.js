...
async function email_otp(param1, param2) {
  ...
  var mailOptions = {
    ...
    to: param2,
    subject: "One Time Password from Salama Services",

    html:
      "One Time Password  from Salama services,<br> Your one time password is.<br> " +
      param1 +
      "<br>" +
      "تأكيد بالبريد الإلكتروني من خدمات أمان ، <br> Your One time password is. <br>" +
      param1
  };
